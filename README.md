...
- **OpenID Connect provider** per tenant: discovery, JWKS, `/authorize`, PAR, `/token`,
  ...
  WebFinger ([endpoints](https://zerosandonesllc.github.io/rIDM/reference/endpoints.html),
  [tokens](https://zerosandonesllc.github.io/rIDM/concepts/tokens.html),
  [token claims](https://zerosandonesllc.github.io/rIDM/reference/token-claims.html)).
- **Browser sign-in flows**: password, magic link, email and SMS codes, self-registration,
  ...
  ([flows and sessions](https://zerosandonesllc.github.io/rIDM/concepts/flows-and-sessions.html)).
- **MFA and passkeys**: TOTP, email and SMS codes, WebAuthn passkeys (passwordless or as a
  ...
  ([MFA](https://zerosandonesllc.github.io/rIDM/concepts/mfa.html),
  [MFA policy](https://zerosandonesllc.github.io/rIDM/admin/mfa-policy.html)).
- **Adaptive authentication**: risk scoring on new devices, new countries, impossible
  ...
  ([adaptive auth](https://zerosandonesllc.github.io/rIDM/admin/adaptive-auth.html)).
- **Users, groups, roles, organizations** and resource servers with scopes and
  permissions ([users, groups and roles](https://zerosandonesllc.github.io/rIDM/concepts/users-groups-roles.html),
  [organizations](https://zerosandonesllc.github.io/rIDM/concepts/organizations.html),
  [resource servers](https://zerosandonesllc.github.io/rIDM/concepts/resource-servers.html)).
- **Identity brokering**: upstream OIDC and social providers, SAML IdPs, LDAP and Active
  Directory, Kerberos desktop sign-in
  ([brokering](https://zerosandonesllc.github.io/rIDM/concepts/brokering.html),
  [SAML upstream](https://zerosandonesllc.github.io/rIDM/admin/saml-upstream.html),
  [LDAP](https://zerosandonesllc.github.io/rIDM/admin/ldap.html),
  [Kerberos](https://zerosandonesllc.github.io/rIDM/admin/kerberos.html)).
- **SAML 2.0 identity provider** for SAML applications
  ([SAML IdP](https://zerosandonesllc.github.io/rIDM/admin/saml-idp.html)).
- **High-assurance clients**: CIBA, FAPI 2.0, mutual TLS, DPoP, token exchange
  ([CIBA and FAPI](https://zerosandonesllc.github.io/rIDM/admin/ciba-fapi.html),
  [mTLS](https://zerosandonesllc.github.io/rIDM/admin/mtls.html),
  [clients](https://zerosandonesllc.github.io/rIDM/concepts/clients.html)).
- **Administration**: an admin API guarded by per-tenant permissions, the admin and account
  ...
  audit log ([access](https://zerosandonesllc.github.io/rIDM/admin/access.html),
  [consoles](https://zerosandonesllc.github.io/rIDM/admin/consoles.html),
  [CLI](https://zerosandonesllc.github.io/rIDM/admin/cli.html),
  [admin API](https://zerosandonesllc.github.io/rIDM/reference/admin-api.html),
  [SCIM](https://zerosandonesllc.github.io/rIDM/admin/scim.html),
  [webhooks and audit](https://zerosandonesllc.github.io/rIDM/admin/webhooks-audit.html)).
- **Security controls**: rate limits, IP rules, CAPTCHA, breached-password check, custom
  domains ([security controls](https://zerosandonesllc.github.io/rIDM/admin/security-controls.html),
  [custom domains](https://zerosandonesllc.github.io/rIDM/admin/custom-domains.html)).
- **Keys**: per-tenant signing keys with rotation, a master key encrypting secrets at rest,
  optionally held in an HSM or KMS
  ([keys](https://zerosandonesllc.github.io/rIDM/concepts/keys.html),
  [key custody](https://zerosandonesllc.github.io/rIDM/deploy/key-custody.html)).
- **Operations**: Valkey cluster and sentinel, Postgres read replicas, per-region data
  ...
  ([Postgres and Valkey](https://zerosandonesllc.github.io/rIDM/deploy/postgres-valkey.html),
  [data residency](https://zerosandonesllc.github.io/rIDM/deploy/data-residency.html),
  [observability](https://zerosandonesllc.github.io/rIDM/deploy/observability.html)).
- **`ridm-auth`**: a crate that validates rIDM tokens in your own Rust API
  ([protect an API](https://zerosandonesllc.github.io/rIDM/quickstarts/protect-an-api.html)).
...
[Run rIDM locally](https://zerosandonesllc.github.io/rIDM/quickstarts/local.html) and
[docker-compose](https://zerosandonesllc.github.io/rIDM/deploy/docker-compose.html); for
production, start with the
[deployment overview](https://zerosandonesllc.github.io/rIDM/deploy/overview.html) and the
[production checklist](https://zerosandonesllc.github.io/rIDM/deploy/checklist.html).
...
[Server configuration](https://zerosandonesllc.github.io/rIDM/reference/configuration.html).
Tenants are configured through the admin API, the consoles or one JSON document per tenant
([tenant configuration document](https://zerosandonesllc.github.io/rIDM/reference/tenant-document.html)).

## Documentation

| Section | What's there |
|---------|--------------|
| [Concepts](https://zerosandonesllc.github.io/rIDM/concepts/tenants.html) | tenants, clients, users, tokens, keys, flows, brokering, events |
| [Quickstarts](https://zerosandonesllc.github.io/rIDM/quickstarts/local.html) | run locally, protect an API, SPA, server-side web app, machine-to-machine |
| [Admin guide](https://zerosandonesllc.github.io/rIDM/admin/consoles.html) | consoles, CLI, tenants, users, clients, MFA, SAML, LDAP, SCIM, webhooks, keys |
| [Reference](https://zerosandonesllc.github.io/rIDM/reference/endpoints.html) | endpoints, admin API (OpenAPI), token claims, configuration, errors |
| [Deployment](https://zerosandonesllc.github.io/rIDM/deploy/overview.html) | compose, container, Helm, TLS, scaling, backup, upgrades, checklist |
| [Migration](https://zerosandonesllc.github.io/rIDM/migrate/overview.html) | from Keycloak or Auth0 |
...
checksums; see [Releases and verification](https://zerosandonesllc.github.io/rIDM/deploy/releases.html)
