...
- [ ] 5.9 Audit: list/filter/export; retention policy per tenant. Migration for partitioned `audit_events` with hash chain. Includes the per-user audit route under `/admin/tenants/{slug}/users/{id}/audit` deferred from 5.4.
