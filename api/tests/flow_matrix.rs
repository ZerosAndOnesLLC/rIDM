...
fn steps() -> Vec<(&'static str, Value)> {
    vec![
        ...
        ("mfa/email/enroll", json!({})),
        ("mfa/email/confirm", json!({"code": "000000"})),
        ("mfa/email/send", json!({})),
        ("mfa/email/verify", json!({"code": "000000"})),
        ("mfa/sms/enroll", json!({"phone": "+15550000001"})),
        ("mfa/sms/confirm", json!({"code": "000000"})),
        ("mfa/sms/send", json!({})),
        ("mfa/sms/verify", json!({"code": "000000"})),
        ("mfa/passkey/register", json!({})),
        (
            "mfa/passkey/register/finish",
            json!({"credential": {"id": "AA", "rawId": "AA", "type": "public-key", "response": {"attestationObject": "AA", "clientDataJSON": "AA"}}}),
        ),
        ("mfa/passkey/start", json!({})),
        (
            "mfa/passkey/finish",
            json!({"credential": {"id": "AA", "rawId": "AA", "type": "public-key", "response": {"authenticatorData": "AA", "clientDataJSON": "AA", "signature": "AA", "userHandle": null}}}),
        ),
        ("passkey/start", json!({})),
        (
            "passkey/finish",
